...
def buscar_archivos(
    ...
    try:
        ...
        registro.info("busqueda_drive_completada", total=len(archivos), consulta=consulta_final)
        return archivos

    except Exception as e:
        registro.error("error_buscar_archivos_drive", error=str(e))
        raise ErrorBusquedaGoogleDrive(f"Error al buscar archivos en Google Drive: {str(e)}")
